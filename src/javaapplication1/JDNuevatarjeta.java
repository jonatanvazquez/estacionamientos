 ...
 * @author Jonatan
 */
public class JDNuevatarjeta extends javax.swing.JDialog {

    /**
     * Creates new form JDNuevatarjeta
     */
    public JDNuevatarjeta(java.awt.Frame parent, boolean modal) {
        super(parent, modal);
        initComponents();
    ...
    private void initComponents() {
        ...
        jPanel1.setBorder(javax.swing.BorderFactory.createTitledBorder("Nueva Tarjeta"));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JDNuevatarjeta.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                JDNuevatarjeta dialog = new JDNuevatarjeta(new javax.swing.JFrame(), true);
