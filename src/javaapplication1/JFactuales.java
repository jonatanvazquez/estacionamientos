 ...
 * @author Jonatan
 */
public class JFactuales extends javax.swing.JFrame {
DefaultTableModel tablausuarios= new DefaultTableModel();
    /**
     * Creates new form JFactuales
     */
    public JFactuales() {
        initComponents();
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(JFactuales.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                new JFactuales().setVisible(true);
            }
        });
    }
